...
MENU_SWITCH_MEGAOS = "切换到 MegaOS (F21)"
MENU_CLOSE = "关闭菜单"
MENU_EXIT = "退出"
MENU_H3C_SOUND_SETTINGS = "启动 H3CSound 设置界面"
...
MSG_H3CCC_RUNNING = "检测到官方 H3C 控制中心正在运行！请先卸载或关闭它，然后才能使用此程序。"
